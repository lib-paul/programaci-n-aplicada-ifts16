 ...
 * @author Ryzen 5
 */
public class formModPaciente extends javax.swing.JFrame {

    /**
     * Creates new form PanelPaciente
     */
    public formModPaciente() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formModPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formModPaciente().setVisible(true);
            }
        });
    }
